...
<html>
	...
	<head>
		...
		<!-- 公共样式 开始 -->
		<link rel="shortcut icon" href="../../../../../../backManage/images/favicon.ico"/>
		...
		<link rel="stylesheet" type="text/css" href="../../../../../../backManage/css/login1.css">
		<script type="text/javascript" src="../../../../../../backManage/js/login1.js"></script>
	</head>
	...
	<body>
		...
		<div class="login_main">
			<div class="box">
				...
				<div class="right">
					<form class="layui-form layui-form-pane" action="adminLogin" method="post">
						...
						<div class="layui-form-item">
							<input type="radio" name="userType" value="管理员" title="管理员" checked lay-filter="userType">
							<input type="radio" name="userType" value="超管" title="超管" lay-filter="userType">
						</div>
					</form>
				</div>
			</div>
		...
		<script>
			layui.use('form', function() {
				...
				form.on('radio(userType)', function(data){
					if(data.value == "管理员"){
						$(".loginBg").css("background","url('../../../../../../backManage/images/login_admin_bg.jpg')");
						$(".login_but").css("cssText", "background-color:#57c201 !important");
					}
					if(data.value == "超管"){
						$(".loginBg").css("background","url('../../../../../../backManage/images/login_sh_bg.jpg')");
